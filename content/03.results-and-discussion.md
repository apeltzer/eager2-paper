...
Table: Comparison of usage and pipeline functionality of common ancient DNA processing
pipelines. Tick represents full functionality, tilde represents partial
functionality cross represents not implemented. {#tbl:pipeline-comparison}.

Table {@tbl:pipeline-comparison} shows a comparison of the functionality
offered by existing aDNA specific pipelines and nf-core/eager.