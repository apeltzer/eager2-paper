...
| EAGER              | 1.92.33  | singularity  | 222.4 ± 2.6 | 22.4 ± 0.5  |1716.5 ± 56.2 |
...
minutes {#tbl:benchmarking-results}.

The results of the benchmarking tests can be seen in Table
{@tbl:benchmarking-results}. nf-core/eager showed lowest runtimes across all
...
flag --max-bwa-threads set to 4 (listed in Table {@tbl:benchmarking-results} as
