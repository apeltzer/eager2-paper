...
DNA and microbial pathogen screening with nf-core/eager. MultiQC v1.10 will be
included in a point release of nf-core/eager, once released by the developer,
but in the meantime can be manually run to get the same results as v1.9 but with
the integrate HOPS heatmap. Data was shotgun data from Barquera et al. 2020
...
information.](images/dualhumanpathogen_exportedmqc_base.png){#fig:dual-human-pathogen
width="70%"}
